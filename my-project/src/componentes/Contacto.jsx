...
const Contacto = () => {
    ...
    return (
        <section className="flex flex-col items-center lg:flex lg:flex-row lg:justify-center">
            ...
            <div className="h-[400px] w-1/2 bg-letrasColor flex flex-col justify-center items-center gap-4">
                ...
                <Link to="/Contact" className="w-[300px] text-center bg-first-color-alt font-body font-bold text-white text-xl p-3 hover:bg-first-color">
                    Dejanos tu consulta
                </Link>
            </div>

            <div className="w-1/2">
                <img src="/src/imagenes/coache.png" className="h-[200px] lg:h-[400px] " alt="" />
            </div>
