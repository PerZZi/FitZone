...
const Programas = () => {
  ...
  return (
    <div className="text-primary uppercase font-primary shadow-lg sticky top-0">
      ...
      <Link className="bg-first-color-alt p-2 text-center lg:h-[40px] lg:mr-4 lg:mt-4 font-body font-bold text-white hover:bg-first-color" to="/Carrito"><FontAwesomeIcon icon={faShoppingCart} className="mr-2" /> Carrito</Link>
      <main>
